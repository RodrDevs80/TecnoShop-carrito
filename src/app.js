...
function cargarProductosPaginaPrincipal(
  ...
  arrayProductos.forEach((producto) => {
    ...
    hCantidad.innerHTML = `<label class="cantidad">Cantidad</label><select class="cantidad" name="cantidad" ><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select>`;
